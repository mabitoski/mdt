...
CONFIG = {
    "source": "legacy-hp-prodesk-600-g4-mt",
    "serial": "NUM_SERIE",
...
def main():
    parser = argparse.ArgumentParser(description="Import PROD - HP Prodesk 600 G4 MT.csv")
    parser.add_argument("--csv", default="/home/christopher/tmp/PROD - HP Prodesk 600 G4 MT.csv")
