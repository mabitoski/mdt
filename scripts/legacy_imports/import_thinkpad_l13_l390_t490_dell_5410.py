...
CONFIG = {
    "source": "legacy-thinkpad-l13-l390-t490-dell-5410",
    "serial": "NUM_SERIE",
...
def main():
    parser = argparse.ArgumentParser(description="Import PROD - Thinkpad L13_L390_T490_DELL 5410.csv")
    parser.add_argument(
        "--csv",
        default="/home/christopher/tmp/PROD - Thinkpad L13_L390_T490_DELL 5410.csv",
    )
