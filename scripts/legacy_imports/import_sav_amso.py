...
CONFIG = {
    ...
    "overall": ("OK ?", 1),
    "problems": ["Problèmes"],
    "notes": ["COMMENTAIRE", "COMMENTAIRE ", "Commentaire"],
    "followups": [
        {
            "role": "double_check",
...
def main():
    parser = argparse.ArgumentParser(description="Import PROD - SAV Amso.csv")
    parser.add_argument("--csv", default="/home/christopher/tmp/PROD - SAV Amso.csv")
